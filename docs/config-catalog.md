...
- `@deepseek-ai/dsh-host-directory-picker-desktop` — requires `loader` ([`packages/host/directory-picker-desktop/src/index.ts`](../packages/host/directory-picker-desktop/src/index.ts))
