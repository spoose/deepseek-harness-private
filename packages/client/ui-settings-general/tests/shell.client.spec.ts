 ...
 * ui-settings-models, ui-settings-plugins, ui-agent-preset,
 * ui-settings-unarchive-sessions, and ui-settings-token-usage. A plugin adding
 * a section changes this list.
 */
const PRODUCT_SECTIONS: readonly string[] = ['general', 'models', 'plugins', 'agent-presets', 'archived-sessions', 'token-usage']
