...
const SUPPORTED_TARGETS = new Set(['linux-arm64', 'mac-arm64', 'mac-x64', 'win-x64'])
 ...
 * @returns {'linux-arm64' | 'mac-arm64' | 'mac-x64' | 'win-x64'} Supported Desktop target name.
 */
export function resolveDesktopBuildTarget(
  ...
  return /** @type {'linux-arm64' | 'mac-arm64' | 'mac-x64' | 'win-x64'} */ (target)
}

/**
 * Return the mutable preparation and artifact directories owned by one release target.
 * @param {'linux-arm64' | 'mac-arm64' | 'mac-x64' | 'win-x64'} target - Supported Desktop target name.
